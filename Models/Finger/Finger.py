...
def add_goal_node(parent, position = [0, 0, 0], showObject = True):
    ...
    goal_mo = goal.addObject('MechanicalObject', name='GoalMO', showObject=showObject, drawMode=1, showObjectScale=3,
                             showColor=[237, 112, 20, 255], position=position)
    return goal_mo
...
class Finger():
    ...
    def addEffectors(self, target, position=[[0.0, Const.Height/2, -3.0*Const.Length]]):
        ...
        effectors.addObject("MechanicalObject", position=TransformedPosEffectors, showObject = True, drawMode = 1, showObjectScale = 3, showColor = [0, 255, 0, 255])
