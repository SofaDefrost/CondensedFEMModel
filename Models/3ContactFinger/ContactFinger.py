...
class Controller(BaseController):
    ...
    def apply_actions(self, value):
        ...
        for i, contact in enumerate(self.list_contacts):
            ...
            contact.ConstraintPoint.imposedValue.value = contact_value
...
def createScene(rootNode, classConfig):
    ...
    # list_effectors = [effectors1.PositionConstraint, effectors2.PositionConstraint, effectors3.PositionConstraint]
