# -*- coding: utf-8 -*-
"""Base controller to interact with the Pneumatic trunk hardware.
"""
...
class EmbeddedController():
    ...
    def get_trajectory(self):
        """Generate the trajectory we want to apply on the robot.
    ...
    def simulate(self):
        ...
        while True:
            ...
            if self.step >= self.waiting_time:
                ...
                pos = utils.current_effector_pos()
